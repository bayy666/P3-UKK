...
<?php $__env->startSection('page-icon'); ?>
    <i class="fas fa-user-plus text-gray-700 mr-3"></i>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-title', 'Tambah Pengguna Baru'); ?>

<?php $__env->startSection('page-subtitle', 'Lengkapi form di bawah untuk menambahkan pengguna baru'); ?>
...
unset($__errorArgs, $__bag); ?>" 
                            ...
                            <option value="2" <?php echo e(old('role') == '2' ? 'selected' : ''); ?>>Petugas</option>
                            <option value="3" <?php echo e(old('role') == '3' ? 'selected' : ''); ?>>User</option>
                        </select>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\M S I\P3-UKK\resources\views/users/create.blade.php ENDPATH**/ ?>