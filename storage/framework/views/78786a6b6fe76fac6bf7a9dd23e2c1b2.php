        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8 border border-orange-100">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" autocomplete="off">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nama" value="" required autocomplete="off" readonly onfocus="this.removeAttribute('readonly');" class="w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition" style="border-color: #E8C5A5; color: #5A3A1A;" onfocus="this.style.borderColor='#D2691E'; this.removeAttribute('readonly');" onblur="this.style.borderColor='#E8C5A5'" placeholder="Masukkan nama lengkap">
                </div>
                <div class="mb-4">
                    <label class="block font-semibold mb-2" style="color: #5A3A1A;">
                        <i class="fas fa-lock mr-2" style="color: #D2691E;"></i>Password
                    </label>
                    <input type="password" name="password" required autocomplete="new-password" readonly onfocus="this.removeAttribute('readonly');" class="w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition" style="border-color: #E8C5A5; color: #5A3A1A;" onfocus="this.style.borderColor='#D2691E'; this.removeAttribute('readonly');" onblur="this.style.borderColor='#E8C5A5'" placeholder="Minimal 6 karakter">
                </div>
                <div class="mb-6">
                    <label class="block font-semibold mb-2" style="color: #5A3A1A;">
                        <i class="fas fa-lock mr-2" style="color: #D2691E;"></i>Konfirmasi Password
                    </label>
                    <input type="password" name="password_confirmation" required autocomplete="new-password" readonly onfocus="this.removeAttribute('readonly');" class="w-full px-4 py-3 border-2 rounded-xl focus:outline-none transition" style="border-color: #E8C5A5; color: #5A3A1A;" onfocus="this.style.borderColor='#D2691E'; this.removeAttribute('readonly');" onblur="this.style.borderColor='#E8C5A5'" placeholder="Masukkan ulang kata sandi">
                </div>
