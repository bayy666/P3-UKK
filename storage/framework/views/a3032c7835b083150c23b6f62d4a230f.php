    ...
    <form method="POST" action="<?php echo e(route('staff.update', $petugas->id_petugas)); ?>" class="space-y-6">
      ...
      <div class="space-y-4">
        <div>
          ...
          <input type="text" name="nama_petugas" value="<?php echo e(old('nama_petugas', $petugas->nama_petugas)); ?>" class="mt-1 w-full border rounded px-3 py-2" autocomplete="off" required>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label class="block text-sm font-medium text-gray-700">Username</label>
            <input type="text" name="username" value="<?php echo e(old('username', $petugas->user->username ?? '')); ?>" class="mt-1 w-full border rounded px-3 py-2" autocomplete="off" required>
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-700">Email (opsional)</label>
            <input type="email" name="email" value="<?php echo e(old('email', $petugas->user->email ?? '')); ?>" class="mt-1 w-full border rounded px-3 py-2" autocomplete="off">
          </div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
        ...
        <div>
          ...
          <input type="text" name="no_hp" value="<?php echo e(old('no_hp', $petugas->no_hp)); ?>" class="mt-1 w-full border rounded px-3 py-2" autocomplete="off" required>
        </div>
      </div>
