<?php $__env->startSection('title', 'Ubah Ruangan'); ?>

<?php $__env->startSection('page-icon'); ?>
    <i class="fas fa-edit text-gray-700 mr-3"></i>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('page-title', 'Ubah Ruangan'); ?>

<?php $__env->startSection('page-subtitle', 'Perbarui informasi ruangan'); ?>
...
<div class="max-w-3xl">
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <!-- Body -->
        <div class="p-8">
            <form action="<?php echo e(route('rooms.update', $room->id_room)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                           id="nama_room" 
                           name="nama_room" 
                           value="<?php echo e(old('nama_room', $room->nama_room)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                           id="lokasi" 
                           name="lokasi" 
                           value="<?php echo e(old('lokasi', $room->lokasi)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                              ...
                              required><?php echo e(old('deskripsi', $room->deskripsi)); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\M S I\P3-UKK\resources\views/rooms/edit.blade.php ENDPATH**/ ?>